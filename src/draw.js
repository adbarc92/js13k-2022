  ...
  loadSprites (img, spriteSize) {
    ...
    for(let i = 0; i < spritesPerImage; i++) {
      for(let j = 0; j < spritesPerImage; j++) {
        ...
        sprites['spr_' + ctr + '_h'] = this.createInvertedSprite(sprite, 1);
        sprites['spr_' + ctr + '_f_h'] = this.createInvertedSprite(fSprite, 1);
        sprites['spr_' + ctr + '_a'] = this.createInvertedSprite(sprite, 2);
        sprites['spr_' + ctr + '_f_a'] = this.createInvertedSprite(fSprite, 2);
        ctr++;
      }
    }
    return sprites;
